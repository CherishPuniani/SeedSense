...
resume_ckpt_path = None #'model_weights/loveda/sfanet/last.ckpt' #"model_weights/loveda/delta-0817l0.8lr/delta-0817l0.8lr.ckpt"  # whether continue training with the checkpoint, default None
strategy = 'auto'
